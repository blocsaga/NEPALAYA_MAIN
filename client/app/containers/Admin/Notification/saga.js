...
function* redirectOnSuccess() {
  ...
  yield put(push('/admin/notification-manage'));
}
...
function* deleteSuccessFunc(action) {
  const snackbarData = {
    message: action.payload.msg || 'Notification delete success!!',
    options: {
      variant: 'success',
    },
  };
...
function* addEditSuccessFunc(action) {
  const snackbarData = {
    message: action.payload.msg || 'Notification update success!!',
    options: {
      variant: 'success',
    },
  };
...
export default function* defaultSaga() {
  ...
  yield takeLatest(types.DELETE_ONE_REQUEST, deleteNotification);
